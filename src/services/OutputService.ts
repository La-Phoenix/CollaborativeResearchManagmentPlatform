import { PrismaClient, ResearchOutput, OutputType } from '@prisma/client';
...
export class OutputService {
   ...
   */
  static async createOutput(projectId: string, outputType: OutputType, citation: string, fileUrl?: string): Promise<ResearchOutput> {
